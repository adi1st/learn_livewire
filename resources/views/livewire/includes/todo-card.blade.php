<div wire:key="{{ $todo->id }}"
    ...
    <div class="flex justify-between space-x-2">
        ...
        <div class="flex">
            <input wire:click="toggle({{ $todo->id }})" class="mr-2" type="checkbox" @checked($todo->completed)>

            @if ($EditTodoID === $todo->id)
                <div class="">
                    <input wire:model.lazy="EditTodoName" type="text" placeholder="Todo.."
        ...
        <div class="flex items-center space-x-2">
            ...
            <button wire:click="delete({{ $todo->id }})" wire:confirm="Are you sure?"
